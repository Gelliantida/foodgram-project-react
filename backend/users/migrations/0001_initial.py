    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, max_length=100, unique=True, validators=[django.core.validators.RegexValidator(message='Недопустимые символы!', regex='^[-a-zA-Z0-9_]+$')], verbose_name='Имя пользователя')),
